# Field Notes: candidate-043

## 📊 Technical Metrics
| Field | Value |
| :--- | :--- |
| **Run ID** | candidate-043 |
| **Timestamp** | 2026-04-14 00:14:19 PDT |
| **Model + Version** | GPT-5.4 medium |
| **Input Tokens** | 111K |
| **Output Tokens** | 6.18K |
| **Total Tokens** | 117K |
| **Wall-clock Time (s)** | 181 |
| **Tool-reported Time (s)**| 126 |
...
* **Notes:** - Items not centered vertically at the end of the spin.
